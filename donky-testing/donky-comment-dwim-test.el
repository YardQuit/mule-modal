;;; donky-comment-dwim-test.el --- Tests for donky-comment-dwim -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky--in-org-src-block-p
;; Selector: (ert "donky-comment-dwim-in-org-src-block-p")
;; ===========================================================================

(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-t-in-src-block ()
...
Expected: non-nil."
  (cl-letf (((symbol-function 'org-element-at-point)
    ...
    (let ((major-mode 'org-mode))
      (should (donky--in-org-src-block-p)))))

(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-false-in-paragraph ()
  "In org-mode with a non-src-block element at point, returns nil.
Expected: nil."
  (cl-letf (((symbol-function 'org-element-at-point)
             (lambda () '(paragraph (:begin 1 :end 10)))))
    (let ((major-mode 'org-mode))
      (should-not (donky--in-org-src-block-p)))))

(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-false-in-headline ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-false-if-org-unbound ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-false-if-org-element-nil ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-p-returns-false-in-non-org-mode ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-p-all-checks-must-pass ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-p-non-list-element ()
...
;; ===========================================================================
;; Section: donky-comment-dwim
;; Selector: (ert "donky-comment-dwim-")
;;
;;           (ert "donky-comment-dwim")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- Non-org single-line ---

(ert-deftest donky-comment-dwim-outside-org-comments-current-line ()
...
(ert-deftest donky-comment-dwim-non-org-without-region ()
...
(ert-deftest donky-comment-dwim-non-org-with-empty-buffer ()
...
(ert-deftest donky-comment-dwim-outside-org-with-region ()
...
(ert-deftest donky-comment-dwim-outside-org-region-at-bol ()
...
(ert-deftest donky-comment-dwim-outside-org-deactivates-mark ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-delegates-to-org-edit ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-single-line-no-region ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-with-region ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-with-region-deactivates-mark ()
...
(ert-deftest donky-comment-dwim-in-org-src-block-error-handling ()
...
Expected: message logged, no error propagated."
  (let (messages caught-error-p)
    ...
    (should messages)
    (should (string-match-p "donky-comment-dwim (org-src): mock error"
                            (car messages)))
    (should-not caught-error-p)))

;;; --- Org src-block: line offset math ---

(ert-deftest donky-comment-dwim-in-org-src-block-line-offset-calculation ()
...
(ert-deftest donky-comment-dwim-org-src-takes-priority ()
...
(ert-deftest donky-comment-dwim-respects-use-region-p ()
...
;;; donky-comment-dwim-test.el ends here
