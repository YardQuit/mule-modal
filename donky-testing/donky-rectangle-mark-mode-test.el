;;; donky-rectangle-mark-mode-test.el --- Tests for donky-rectangle-mark-mode -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-rectangle-mark-mode basic functionality
;; Selector: (ert "donky-rectangle-mark-mode-")
;; ===========================================================================

(ert-deftest donky-rectangle-mark-mode-toggles-on ()
  "Calling donky-rectangle-mark-mode enables rectangle-mark-mode.
Expected: rectangle-mark-mode is active after command."
  (with-temp-buffer
    (insert "hello\nworld")
    (goto-char 1)
    (donky-rectangle-mark-mode)
    (should (bound-and-true-p rectangle-mark-mode))
    (should (mark))))

(ert-deftest donky-rectangle-mark-mode-advances-point ()
...
(ert-deftest donky-rectangle-mark-mode-creates-rectangular-selection ()
...
;; ===========================================================================
;; Section: donky-rectangle-mark-mode edge cases
;; Selector: (ert "donky-rectangle-mark-mode-edge")
;; ===========================================================================

(ert-deftest donky-rectangle-mark-mode-edge-empty ()
...
(ert-deftest donky-rectangle-mark-mode-edge-at-buffer-start ()
...
(ert-deftest donky-rectangle-mark-mode-edge-at-buffer-end ()
...
(ert-deftest donky-rectangle-mark-mode-edge-single-character ()
...
(ert-deftest donky-rectangle-mark-mode-edge-multi-line ()
...
(ert-deftest donky-rectangle-mark-mode-edge-before-newline ()
...
(ert-deftest donky-rectangle-mark-mode-edge-on-newline ()
...
(ert-deftest donky-rectangle-mark-mode-edge-has-mark ()
...
(ert-deftest donky-rectangle-mark-mode-edge-call-interactively ()
  "Command can be called interactively without error.
Expected: no errors, rect mode enabled."
  (with-temp-buffer
    (insert "hello")
    (goto-char 1)
    (call-interactively #'donky-rectangle-mark-mode)
    (should (bound-and-true-p rectangle-mark-mode))))

(ert-deftest donky-rectangle-mark-mode-edge-region-boundaries ()
...
(ert-deftest donky-rectangle-mark-mode-edge-after-right-char ()
...
(ert-deftest donky-rectangle-mark-mode-edge-preserves-text ()
...
(ert-deftest donky-rectangle-mark-mode-edge-with-prefix-arg ()
...
(ert-deftest donky-rectangle-mark-mode-edge-empty-at-start ()
...
;;; donky-rectangle-mark-mode-test.el ends here
