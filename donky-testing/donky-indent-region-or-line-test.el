;;; donky-indent-region-or-line-test.el --- Tests for donky-indent-region-or-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-indent-region-or-line
;; Selector: (ert "donky-indent-region-or-line")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- Path selection: use-region-p ---

(ert-deftest donky-indent-region-or-line-use-region-p-truthy-takes-region-path ()
  ...
  (let ((indented-bounds nil))
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'use-region-p)
        ...
        (donky-indent-region-or-line)))
    (should indented-bounds)
    (should (= (car indented-bounds) 1))
    (should (= (cadr indented-bounds) 12))))

(ert-deftest donky-indent-region-or-line-use-region-p-falsy-takes-line-path ()
...
(ert-deftest donky-indent-region-or-line-indent-single-line-region ()
...
(ert-deftest donky-indent-region-or-line-indent-multi-line-region ()
...
(ert-deftest donky-indent-region-or-line-indent-partial-line-region ()
...
(ert-deftest donky-indent-region-or-line-region-from-middle-of-buffer ()
...
(ert-deftest donky-indent-region-or-line-indent-current-line-simple ()
...
(ert-deftest donky-indent-region-or-line-indent-current-line-middle ()
...
(ert-deftest donky-indent-region-or-line-indent-second-line ()
...
(ert-deftest donky-indent-region-or-line-indent-third-line-from-end ()
...
(ert-deftest donky-indent-region-or-line-indent-empty-line ()
...
(ert-deftest donky-indent-region-or-line-indent-single-char-line ()
...
(ert-deftest donky-indent-region-or-line-indent-last-line-no-newline ()
...
(ert-deftest donky-indent-region-or-line-indents-whole-buffer-once ()
...
(ert-deftest donky-indent-region-or-line-preserves-buffer-text ()
...
(ert-deftest donky-indent-region-or-line-call-interactively ()
...
Expected: no error."
  (with-temp-buffer
    ...
    (cl-letf (((symbol-function 'use-region-p)
              ...
              ((symbol-function 'indent-region)
               (lambda (beg end) (ignore beg end))))
      (call-interactively #'donky-indent-region-or-line))
    t))

;;; donky-indent-region-or-line-test.el ends here
