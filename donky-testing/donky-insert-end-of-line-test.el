;;; donky-insert-end-of-line-test.el --- Tests for donky-insert-end-of-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-insert-end-of-line
;; Selector: (ert "donky-insert-end-of-line")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- Basic functionality ---

(ert-deftest donky-insert-end-of-line-moves-and-enters-insert ()
  "Moves point to end of line, then enters insert mode.
Buffer: \"hello world\\n\" — 12 chars.
Point at 1, moves to 12 (newline at position 12).
Expected: donky-enter-insert called, point at 12."
  (let (entered)
    (with-temp-buffer
      (insert "hello world\n")
      (goto-char 1)
      (cl-letf (((symbol-function 'donky-enter-insert)
        ...
        (donky-insert-end-of-line))
      (should entered)
      (should (= (point) 12)))))

(ert-deftest donky-insert-end-of-line-call-order ()
  "move-end-of-line executes before donky-enter-insert.
...
(ert-deftest donky-insert-end-of-line-from-middle-of-line ()
...
(ert-deftest donky-insert-end-of-line-from-beginning-of-line ()
...
(ert-deftest donky-insert-end-of-line-from-second-line ()
...
(ert-deftest donky-insert-end-of-line-from-third-line ()
...
(ert-deftest donky-insert-end-of-line-already-at-end ()
  "Point already at end of line stays at same position.
Buffer: \"hello\\n\" — 6 chars.
Point at 6 (newline), stays at 6.
Expected: point at 6, donky-enter-insert still called."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 6)
...
(ert-deftest donky-insert-end-of-line-empty-buffer ()
...
(ert-deftest donky-insert-end-of-line-single-char-buffer ()
...
(ert-deftest donky-insert-end-of-line-single-char-with-newline ()
...
(ert-deftest donky-insert-end-of-line-empty-line ()
...
(ert-deftest donky-insert-end-of-line-empty-line-second ()
...
(ert-deftest donky-insert-end-of-line-no-trailing-newline ()
...
(ert-deftest donky-insert-end-of-line-multi-line-last-char ()
...
(ert-deftest donky-insert-end-of-line-skips-trailing-whitespace ()
...
(ert-deftest donky-insert-end-of-line-with-tabs ()
...
(ert-deftest donky-insert-end-of-line-preserves-buffer-text ()
...
(ert-deftest donky-insert-end-of-line-calls-eol-exactly-once ()
...
(ert-deftest donky-insert-end-of-line-calls-enter-insert-exactly-once ()
...
(ert-deftest donky-insert-end-of-line-call-interactively ()
...
Expected: no error, point at end of line, insert entered."
  (let (entered)
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'donky-enter-insert)
                 (lambda () (setq entered t))))
        (call-interactively #'donky-insert-end-of-line))
      (should entered)
      (should (= (point) 12)))))

;;; --- Ignores prefix arg ---

(ert-deftest donky-insert-end-of-line-ignores-prefix-arg ()
...
;;; donky-insert-end-of-line-test.el ends here
