;;; donky-yank-test.el --- Tests for donky-yank -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-yank
;; Selector: (ert "donky-yank")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- No region: simple yank ---

(ert-deftest donky-yank-no-region-calls-clipboard-yank ()
...
(ert-deftest donky-yank-no-region-skips-delete-active-region ()
...
(ert-deftest donky-yank-no-region-clipboard-yank-called-once ()
...
(ert-deftest donky-yank-region-deletes-then-yanks ()
...
(ert-deftest donky-yank-region-call-order ()
...
(ert-deftest donky-yank-region-clipboard-yank-called-once ()
...
(ert-deftest donky-yank-region-delete-active-region-called-once ()
...
(ert-deftest donky-yank-no-region-inserts-clipboard-content ()
...
(ert-deftest donky-yank-region-replaces-with-clipboard-content ()
...
(ert-deftest donky-yank-no-region-preserves-existing-text ()
...
(ert-deftest donky-yank-empty-buffer-no-region ()
...
(ert-deftest donky-yank-empty-buffer-with-region ()
...
(ert-deftest donky-yank-region-covers-entire-buffer ()
...
(ert-deftest donky-yank-call-interactively-no-region ()
  ...
  (let (yanked)
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'use-region-p)
                ...
                ((symbol-function 'clipboard-yank)
                 (lambda () (setq yanked t))))
        (call-interactively #'donky-yank)))
    (should yanked)))

(ert-deftest donky-yank-call-interactively-with-region ()
...
(ert-deftest donky-yank-ignores-prefix-arg ()
