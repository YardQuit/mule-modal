;;; donky-insert-beginning-of-line-test.el --- Tests for donky-insert-beginning-of-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-insert-beginning-of-line
;; Selector: (ert "donky-insert-beginning-of-line")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- Basic functionality ---

(ert-deftest donky-insert-beginning-of-line-moves-and-enters-insert ()
  "Moves point to beginning of line, then enters insert mode.
Buffer: \"hello world\\n\" — 12 chars.
Point at 6, moves to 1 (beginning of line).
Expected: donky-enter-insert called, point at 1."
  (let (entered)
    (with-temp-buffer
      (insert "hello world\n")
      (goto-char 6)
      (cl-letf (((symbol-function 'donky-enter-insert)
        ...
        (donky-insert-beginning-of-line))
      (should entered)
      (should (= (point) 1)))))

(ert-deftest donky-insert-beginning-of-line-call-order ()
  "beginning-of-line executes before donky-enter-insert.
...
(ert-deftest donky-insert-beginning-of-line-from-middle-of-line ()
...
(ert-deftest donky-insert-beginning-of-line-from-end-of-line ()
...
(ert-deftest donky-insert-beginning-of-line-from-second-line ()
...
(ert-deftest donky-insert-beginning-of-line-from-third-line ()
...
(ert-deftest donky-insert-beginning-of-line-already-at-beginning ()
  "Point already at beginning of line stays at same position.
Buffer: \"hello\\n\" — 6 chars.
Point at 1, moves to 1 (no movement).
Expected: point at 1, donky-enter-insert still called."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 1)
...
(ert-deftest donky-insert-beginning-of-line-empty-buffer ()
...
(ert-deftest donky-insert-beginning-of-line-single-char-buffer ()
...
(ert-deftest donky-insert-beginning-of-line-single-char-with-newline ()
...
(ert-deftest donky-insert-beginning-of-line-empty-line ()
...
(ert-deftest donky-insert-beginning-of-line-empty-line-second ()
...
(ert-deftest donky-insert-beginning-of-line-no-trailing-newline ()
...
(ert-deftest donky-insert-beginning-of-line-preserves-buffer-text ()
...
(ert-deftest donky-insert-beginning-of-line-calls-bol-exactly-once ()
...
(ert-deftest donky-insert-beginning-of-line-calls-enter-insert-exactly-once ()
...
(ert-deftest donky-insert-beginning-of-line-call-interactively ()
...
Expected: no error, point at beginning of line, insert entered."
  (let (entered)
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'donky-enter-insert)
                 (lambda () (setq entered t))))
        (call-interactively #'donky-insert-beginning-of-line))
      (should entered)
      (should (= (point) 1)))))

;;; --- Ignores prefix arg ---

(ert-deftest donky-insert-beginning-of-line-ignores-prefix-arg ()
...
;;; donky-insert-beginning-of-line-test.el ends here
