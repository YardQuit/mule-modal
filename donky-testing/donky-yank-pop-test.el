;;; donky-yank-pop-test.el --- Tests for donky-yank-pop -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-yank-pop
;; Selector: (ert "donky-yank-pop")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- No region: simple yank-pop ---

(ert-deftest donky-yank-pop-no-region-calls-yank-pop ()
...
(ert-deftest donky-yank-pop-no-region-skips-delete-active-region ()
...
(ert-deftest donky-yank-pop-no-region-yank-pop-called-once ()
...
(ert-deftest donky-yank-pop-region-deletes-then-pops ()
...
(ert-deftest donky-yank-pop-region-call-order ()
...
(ert-deftest donky-yank-pop-region-yank-pop-called-once ()
...
(ert-deftest donky-yank-pop-region-delete-active-region-called-once ()
...
(ert-deftest donky-yank-pop-no-region-inserts-content ()
...
(ert-deftest donky-yank-pop-region-replaces-with-content ()
...
(ert-deftest donky-yank-pop-empty-buffer-no-region ()
...
(ert-deftest donky-yank-pop-empty-buffer-with-region ()
...
(ert-deftest donky-yank-pop-region-covers-entire-buffer ()
...
(ert-deftest donky-yank-pop-call-interactively-no-region ()
  ...
  (let (popped)
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'use-region-p)
                ...
                ((symbol-function 'yank-pop)
                 (lambda () (setq popped t))))
        (call-interactively #'donky-yank-pop))
      (should popped))))

(ert-deftest donky-yank-pop-call-interactively-with-region ()
...
(ert-deftest donky-yank-pop-ignores-prefix-arg ()
...
;;; donky-yank-pop-test.el ends here
