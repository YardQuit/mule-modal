;;; donky-goto-line-test.el --- Tests for donky-goto-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donky-goto-line
;; Selector: (ert "donky-goto-line")
;;           runs ALL tests in this file
;; ===========================================================================

;;; --- Basic navigation ---

(ert-deftest donky-goto-line-go-to-line-1 ()
...
(ert-deftest donky-goto-line-go-to-line-2 ()
...
(ert-deftest donky-goto-line-go-to-line-3 ()
...
(ert-deftest donky-goto-line-from-non-minimum-position ()
...
(ert-deftest donky-goto-line-from-end-of-buffer ()
...
(ert-deftest donky-goto-line-line-beyond-buffer ()
...
(ert-deftest donky-goto-line-line-at-buffer-end ()
...
(ert-deftest donky-goto-line-read-number-prompted ()
    ...
    (with-temp-buffer
      ...
      (cl-letf (((symbol-function 'read-number)
                 (lambda (&rest _)
                   ...
                   1)))
        (call-interactively #'donky-goto-line))
      (should read-number-called))))

(ert-deftest donky-goto-line-input-is-captured ()
...
(ert-deftest donky-goto-line-empty-buffer-line-1 ()
...
(ert-deftest donky-goto-line-single-line-buffer ()
...
(ert-deftest donky-goto-line-single-line-with-newline ()
...
(ert-deftest donky-goto-line-request-zero-or-negative ()
...
(ert-deftest donky-goto-line-large-line-number ()
...
(ert-deftest donky-goto-line-preserves-buffer-text ()
...
(ert-deftest donky-goto-line-goes-to-min-first ()
...
;;; donky-goto-line-test.el ends here
